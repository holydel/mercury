...
void TestBedApplication::Initialize() {
   ...
   // ::Windows::Storage::Streams::pacage::Current().InstalledLocation()
  //  hstring installPath = ::Windows::ApplicationModel::Package::Current().InstalledLocation().Path();
    //std::wstring filePath = std::wstring(installPath.c_str()) + L"\\Assets\\click.wav";

    mercury::ll::sound::SoundHandle sound = mercury::ll::sound::CreateSoundFromFile(u8"Assets\\Nightwish_-_Ghost_Love_Score_Remastered.mp3");
